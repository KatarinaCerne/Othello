        ...
        if globina == 0 or self.igra.konec()!=None:
            ...
            if igralec:
              ...
              # Na potezi je igralec, vrednost igre maksimiziramo
                ...
                #print("igralec",mozne_poteze_igralca)
                #print("nasprotnik", self.igra.poteze(drugi(self.igra.na_potezi)))
                ...
                #print("minimiziram " + self.igra.na_potezi, globina)
              # Na potezi je nasprotnik, vrednost igre minimiziramo
                ...
                #random.shuffle(mozne_poteze_nasprotnika)
